...
await conn.sendMessage(m.chat, { document: { url: downloadUrl }, fileName: `${yt_play[0].title}.mp4`, caption: `${global.botname}` }, { quoted: m });
await m.react(done);
} else {
await conn.sendMessage(m.chat, { video: { url: downloadUrl }, fileName: `${yt_play[0].title}.mp4`, caption: `${global.botname}`, thumbnail: yt_play[0].thumbnail, mimetype: 'video/mp4' }, { quoted: m });
await m.react(done);
}} catch (e1) {
try {  
await m.react(rwait);  
...
await await conn.sendMessage(m.chat, { video: { url: dl_url }, fileName: `${ttl}.mp4`, mimetype: 'video/mp4', caption: `${global.botname}`, thumbnail: await fetch(yt.thumbnail) }, { quoted: m })
await m.react(done);
} catch (e2) {
try {    
await m.react(rwait);
...
conn.sendMessage(m.chat, { video: { url: downloadUrl }, fileName: `${yt_play[0].title}.mp4`, caption: `${global.botname}`, thumbnail: yt_play[0].thumbnail, mimetype: 'video/mp4' }, { quoted: m });
await m.react(done);
} catch (e6) {
try {
await m.react(rwait);
...
if (fileSize > LimitVid) {
await conn.sendMessage(m.chat, { document: { url: audiop }, fileName: `${yt_play[0].title}.mp4`, caption: `${global.botname}` }, { quoted: m });
await m.react(done);
} else {
await conn.sendMessage(m.chat, { video: { url: audiop }, fileName: `${yt_play[0].title}.mp4`, caption: `${global.botname}`, thumbnail: yt_play[0].thumbnail, mimetype: 'video/mp4' }, { quoted: m });
await m.react(done);
}} catch (e) {    
await m.react(error);
console.log(e);
...
const downloadUrl = delius.data.download.url;
//const fileSize = await getFileSize(downloadUrl);
await conn.sendMessage(m.chat, { document: { url: downloadUrl }, fileName: `${yt_play[0].title}.mp4`, caption: `${global.botname}`, thumbnail: yt_play[0].thumbnail, mimetype: 'video/mp4' }, { quoted: m })    
await m.react(done);
} catch (e1) {
try {
await m.react(rwait);
...
handler.command = ['play3', 'play4', 'playdoc', 'playdoc2']
handler.coin = 1
